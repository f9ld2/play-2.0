 ...
 *      <doc:example> 
 *          <doc:source> 
 *              <cc-tencd-input cc-label="店舗" cc-partition="3" id="tenCd" name="tenCd" ng-model="cond.tenCd" cc-required="true" 
 *                  cc-notexist="false" cc-delexist="true" cc-shortname="true" cc-parameter01="result.kaisyaCd"
 *                  cc-parameter02="result.jigyobuCd" cc-parameter03="result.hakkoDay" id2="tenNm" name2="tenNm" 
 *                  ng-model2="result.tenNm"></cc-tencd-input>
 *          </doc:source> 
 *          <doc:scenario> 
 *          </doc:scenario> 
 *      </doc:example>
                    ...
                    return {
                        ...
                        template : function(element, attrs) {
                            ...
                            if (attrs.ccReadonly == 'true') {
                                ...
                                htmlText += ' ng-minlength="3" cc-blur-validation error-message="{{error}}" >';
                            }
                        ...
                        link : function(scope, element, attrs, ctrl) {
                            ...
                            function validation(value) {
                                ...
                                if (isEmpty(scope.ccParameter01) || isEmpty(scope.ccParameter02) || isEmpty(value) || attrs.ngModel2 == undefined) {
                                    return;
                                }
                                ...
                                var requestWithHakkoDay = function(hakkoDay) {
                                    $http(
                                            {
                                                method : 'GET',
                                                url : '/core/codename/m006tenm/' + value + '/' + scope.ccParameter01 + '/'
                            ...
                            scope.blurCallback = function(value) {
                                ...
                                if (angular.isDefined(attrs.id2) && angular.isDefined(attrs.name2)
                                    ...
                                    if (!checkData || checkData && record.length == 0
                                        ...
                                        scope.ngModel2 = undefined;
                                    } else if (checkData && arecord.length != 0) {
