/**
 * @ngdoc directive
 * @name chasecore.cc-tengrpcd-input
 * @restrict E
 * @function
 * 
 * @description (コード入力時)店舗グループマスタから『店舗グループ名称』を取得・表示する                                                                                                                                                                                                                                                                                           
 * 
 * @example 
 *      <doc:example> 
 *          <doc:source> 
 *              <cc-tengrpcd-input cc-label="店舗グループ" cc-partition="3" id="grpCd" name="grpCd" ng-model="cond.grpCd" cc-required="true" 
 *                  cc-notexist="false" cc-delexist="true" cc-key1="MA" cc-parameter01="result.jigyobuCd"
 *                  cc-parameter02="result.bmnCd" cc-parameter03="result.hakkoDay" id2="ptnmNm" name2="ptnmNm" 
 *                  ng-model2="result.ptnmNm"></cc-tengrpcd-input>
 *          </doc:source> 
 *          <doc:scenario> 
 *          </doc:scenario> 
 *      </doc:example>
                ...
                function(CSS_CLASS, $http, $timeout, UserInfo) {
                    ...
                    return {
                        ...
                        template : function(element, attrs) {
                            ...
                            // input no1
                            htmlText += '<input error-message="{{error}}" type="text" cc-type="code" id="' + attrs.id
                                    + '" name="' + attrs.name
                            ...
                            if (angular.isDefined(attrs.ngModel2)) {
                                ...
                                htmlText += ' id="' + attrs.id2 + '" name="'
                                        + attrs.name2 + '" class="' + inputClass2 + '" ng-model="ngModel2" ng-disabled="true" maxlength="10">';
                            }
                        ...
                        link : function(scope, element, attrs, ctrl) {
                            ...
                            function validation(value) {
                                ...
                                if (isEmpty(attrs.ccKey1) || isEmpty(scope.ccParameter01) 
                                        || isEmpty(scope.ccParameter02) || isEmpty(value) 
                                        || attrs.ngModel2 == undefined) {
                                    return value;
                                }
                                ...
                                var requestWithHakkoDay = function(hakkoDay) {
                                    $http(
                                            {
                                                method : 'GET',
                                                url : '/core/codename/m012tngm/' + value + '/' + attrs.ccKey1 + 
                                                '/' + scope.ccParameter01 + '/'
                                                + scope.ccParameter02 + '?hakkoDay=' + hakkoDay
                                            }).success(
                                                    function(data) {
                                                        record = data;
                                                        // 3)結果チェック
                                ...
                                var hakkoDay = scope.ccParameter03;
                                if(!isEmpty(hakkoDay)) {
