/**
 * @ngdoc directive
 * @name chasecore.cc-kbn-combobox
 * @restrict E
 * @function
 *
 * @description
...
diretiveApp.directive('ccKbnCombobox', function(CSS_CLASS, $http, $compile, $timeout, X007KbnMaster, $rootScope, ClearComboboxOptions, AddKbnComboboxOptions) {
