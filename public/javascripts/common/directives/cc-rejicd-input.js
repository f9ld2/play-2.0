/**
 * @ngdoc directive
 * @name chasecore.cc-rejicd-input
 * @restrict E
 * @function
 * 
 * @description (コード入力時)分類マスタから『(レジ部門)分類名称(or略称)』を取得・表示する
 * 
 * @example 
 *      <doc:example> 
 *          <doc:source> 
 *             <cc-rejicd-input cc-label="レジ部門" cc-partition="3" id="rejiCd" name="rejiCd" ng-model="cond.rejiCd"
 *                  cc-required="true" cc-notexist="false" cc-delexist="true" cc-shortname="true" cc-parameter01="cond.jigyobuCd" cc-parameter02="cond.hakkoDay" id2="bnrNm"
                    ...
                    return {
                        ...
                        template : function(element, attrs) {
                            ...
                            htmlText += '<input type="text" cc-type="code" id="' + attrs.id
                                    ...
                                    + ' maxlength="4" onKeyDown="return setNextFocus(this);" ';
                            ...
                            if (attrs.ccReadonly == 'true') {
                                ...
                                htmlText += ' ng-minlength="4" cc-blur-validation error-message="{{error}}" >';
                            }
                            ...
                            function validation(value) {
                                ...
                                var requestWithHakkoDay = function(hakkoDay) {
                                    $http(
                                            {
                                                method : 'GET',
                                                url : '/core/codemaster/m005bnrm/' + value + '/' + scope.ccParameter01
                                                + '?hakkoDay=' + hakkoDay
                                            }).success(
                                                    function(data) {
                                                        record = data;
