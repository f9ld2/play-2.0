/**
 * @ngdoc directive
 * @name chasecore.cc-chubnrcd-input
 * @restrict E
 * @function
 *
 * @description (コード入力時)分類マスタから『(ライン)分類名称(or略称)』を取得・表示する
 *
 * @example
 *      <doc:example>
 *          <doc:source>
 *              <cc-chubnrcd-input cc-label="ライン" cc-partition="3" id="chubnrCd" name="chubnrCd" ng-model="cond.chubnrCd"
 *                  cc-required=true cc-notexist=false cc-delexist=true cc-shortname=true cc-parameter01="result.jigyobuCd"
 *                  cc-parameter02="result.bmnCd" cc-parameter03="result.hakkoDay" id2="bnrNm" name2="bnrNm" ng-model2="cond.bnrNm">
 *              </cc-chubnrcd-input>
 *          </doc:source>
 *          <doc:scenario>
 *          </doc:scenario>
            ...
            return {
                ...
                template: function(element, attrs) {
                    ...
                    if (angular.isDefined(attrs.ngModel2)) {
                        ...
                        htmlText += ' id="' + attrs.id2 + '" class="' + inputClass2 + '" name="' + attrs.name2 + '" ng-model="ngModel2" ng-disabled="true" maxlength="' + (attrs.ccShortname == "true" ? '5">' : '20">');
                    }
                ...
                link: function(scope, element, attrs, ctrl) {
                    ...
                    function validation(value) {
                        ...
                        var requestWithHakkoDay = function(hakkoDay) {
                            $http({
                                method: 'GET',
                                url: '/core/codename/m005bnrm3/' + value + '/' + scope.ccParameter01 + '/' + scope.ccParameter02 + '?hakkoDay=' + hakkoDay
                            }).success(
                                function(data) {
                                    record = data;
                                    // 3)結果チェック
