...
// LOCHV START 7/3/2014
ngGridDirectives.directive("ngCellCustom", ["$compile", "$domUtilityService",
    function(e, t) {
        var n = {
            scope: !1,
            compile: function() {
                return {
                    pre: function(t, n) {
                        var o, i = t.col.cellTemplate.replace(COL_FIELD, "row.entity." + t.col.field);
                        var r = e(i)(t);
                        n.append(r)
                    },
                    post: function(e, n) {
                    ...
                    return grid.init().then(function() {
                        ...
                        if (typeof options.data === "string") {
                            var dataWatcher = function (a) {
                                ...
                                grid.data = $.extend([], a);
                                // config full render for fist load
                                if (options.fullRendered == true) {
                                    EXCESS_ROWS = grid.data.length;
                                }
                                // config full render for fist load
...
ngGridDirectives.directive('ngViewport', [function() {
    return function($scope, elm) {
        ...
        function scroll (evt) {
            ...
            $scope.$emit('ngGridEventFinishScroll');
            return true;
        }
