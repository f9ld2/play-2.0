 ...
 *  ===================================================================
 */
var app = angular.module('sijp7110', ['sijp7110Services', 'ui','ui.select2','directives']);
app.controller("SIJP7110Ctrl",function($scope, $window, SIJP7110Report, SIJP7110Init, $sce, Message, MsgConst, HttpConst, 
        Dialog, DialogInfo, $interval, FocusConst, Client, AppConst, UserInfo, $timeout) {
    ...
    $scope.initCond = function() {
        // $timeout(function() {
            var maker = SIJP7110Init.query({}, function() {
	...
	$scope.doExecute = function() {
    	...
    	executeDialog.result.then(function () {
            ...
            var report = SIJP7110Report.query($scope.cond, function() {
