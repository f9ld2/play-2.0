 ...
 * ===================================================================
 */
var app = angular.module('sijp7060', ['sijp7060Services', 'ui', 'ui.select2', 'directives']);
app.controller("SIJP7060Ctrl", function($scope, $window, $interval, FocusConst, Message, MsgConst, HttpConst, 
		Sijp7060Report, Sijp7060Init, $sce, Dialog, DialogInfo, AppConst, Client, UserInfo) {
    ...
    $scope.doExecute = function() {
        ...
        doExecuteDialog.result.then(function() {
            ...
            var report = Sijp7060Report.query($scope.cond, function() {
    ...
    $scope.initCond = function() {
        var maker = Sijp7060Init.query({}, function() {
            if (maker != undefined) {
                $scope.cond.outJigyobuCd = maker[0].outJigyobuCd;
