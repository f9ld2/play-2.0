 ...
 * =================================================================== */
var app = angular.module('gnjp7000', ['gnjp7000Services', 'ui', 'ui.select2', 'directives']);
app.controller("GNJP7000Ctrl", function($scope, $window, GNJP7000Report, GNJP7000Init, $sce, Message, MsgConst,
    ...
    $scope.doExecute = function() {
        ...
        doExecuteDialog.result.then(function() {
            ...
            var report = GNJP7000Report.query($scope.cond, function() {
    ...
    $scope.initCond = function() {
        var maker = GNJP7000Init.query({}, function() {
            if (maker != undefined) {
                ...
                $scope.cond.chubnrCd = maker[0].chubnrCd;
                $scope.cond.shobnrCd = maker[0].shobnrCd;
            }
        }, function(response) {
