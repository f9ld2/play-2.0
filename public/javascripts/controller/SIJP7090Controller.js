 ...
 * ===================================================================
 */
var app = angular.module('sijp7090', ['sijp7090Services', 'ui', 'ui.select2', 'directives']);
app.controller("SIJP7090Ctrl", function($scope, $window, $interval, FocusConst, Message, MsgConst, HttpConst, 
        Sijp7090Report, Sijp7090Init, $sce, Dialog, DialogInfo, AppConst, Client, UserInfo) {
    ...
    $scope.cond.hatDayFr = UserInfo.unyoDate;
    $scope.cond.hatDayTo = UserInfo.unyoDate;
    $scope.cond.hinKkKbn  = '';
    ...
    $scope.doExecute = function() {
        ...
        doExecuteDialog.result.then(function() {
            ...
            var report = Sijp7090Report.query($scope.cond, function() {
    ...
    $scope.initCond = function() {
        var maker = Sijp7090Init.query({}, function() {
            if (maker != undefined) {
