 ...
 * ===================================================================
 */
var app = angular.module('sijp1150', [ 'sijp1150Services', 'ui', 'ui.select2', 'directives' ]);
app.controller("SIJP1150Ctrl", function($scope, $window, Message, MsgConst, FocusConst,
        HttpConst, $interval,Sijp1150Report, $sce, Dialog, DialogInfo,AppConst, Client) {
    ...
    $scope.doExecute = function() {
        ...
        doExecuteDialog.result.then(function () {
            ...
            var report = Sijp1150Report.query($scope.cond, function() {
    ...
    $scope.doClear = function() {
        ...
        clearDialog.result.then(function () {
            ...
            $scope.cond.entryKbn = "";
            $scope.cond.dpyKbn = "";
            $scope.cond.idoDenKbn = "";
            $scope.cond.tenCd = "";
            $scope.cond.bmnCd = "";
            $scope.cond.torihikiCd = "";
            $scope.cond.nhnYMDSt = "";
            $scope.cond.nhnYMDEd = "";
            $scope.cond.cmnInsddSt = "";
            $scope.cond.cmnInsddEd = "";
            $scope.cond.keijdateEd = "";
            $scope.cond.keijdateSt = "";
            $scope.cond.tenCds = "";
            $scope.cond.bmnCds = "";
            $scope.cond.torihikiCds = "";
