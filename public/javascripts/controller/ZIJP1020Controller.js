...
var app = angular.module('zijp1020', ['zijp1020Services', 'ui', 'ui.select2', 'directives']);
app.controller("ZIJP1020Ctrl", function($scope, $window, $sce, ZIJP1020Report, Message, MsgConst,
        $interval, HttpConst, Dialog, DialogInfo, AppConst, FocusConst, Client) {
    $scope.cond = {};
    $scope.result = {};
    ...
    $scope.doExecute = function() {
        ...
        confirmDialog.result.then(function() {
            ...
            var report = ZIJP1020Report.query($scope.cond, function() {
                $scope.result = report;
