 ...
 * ===================================================================
 */
var app = angular.module('sijp7050', ['sijp7050Services', 'ui', 'ui.select2', 'directives']);
app.controller("SIJP7050Ctrl", function($scope, $window, $interval, FocusConst, Message, MsgConst, HttpConst, 
        Sijp7050Report, Sijp7050Init, $sce, Dialog, DialogInfo, AppConst, Client, UserInfo) {
    ...
    $scope.doExecute = function() {
        ...
        doExecuteDialog.result.then(function() {
            ...
            var report = Sijp7050Report.query($scope.cond, function() {
    ...
    $scope.initCond = function() {
        var maker = Sijp7050Init.query({}, function() {
            if (maker != undefined) {
