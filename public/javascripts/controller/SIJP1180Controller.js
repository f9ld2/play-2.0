...
var app = angular.module('sijp1180', ['sijp1180Services', 'ui', 'ui.select2', 'directives']);
app.controller("SIJP1180Ctrl", function($scope, $window, FocusConst, Message, MsgConst, HttpConst, 
        SIJP1180Report, $sce, Dialog, DialogInfo, $interval, Client) {
    ...
    $scope.doExecute = function() {
        ...
        doExecuteDialog.result.then(function() {
            ...
            var report = SIJP1180Report.query($scope.cond, function() {
