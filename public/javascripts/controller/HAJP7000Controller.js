...
var app = angular.module('hajp7000', [ 'hajp7000Services', 'ui', 'ui.select2', 'directives', 'ui.bootstrap' ]);
app.controller("HAJP7000Ctrl", function($scope, $window, HAJP7000Report, $sce, Message, MsgConst, HttpConst, Dialog,
		HAJP7000Init,$interval, AppConst, FocusConst, Client, UserInfo) {
    ...
    $scope.cond.sendDay = UserInfo.unyoDate;
    /**
     * Export pdf file
     * 
     * @param 
    ...
    $scope.doExecute = function() {
        ...
        confirmDialog.result.then(function () {
            ...
            var report = HAJP7000Report.query($scope.cond, function() {
    ...
    $scope.initCond = function() {
        var maker = HAJP7000Init.query({}, function() {
            if (maker != undefined) {
