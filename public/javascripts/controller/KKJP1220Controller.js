 ...
 * =================================================================== */
var app = angular.module('kkjp1220', ['kkjp1220Services', 'ui','ui.select2','directives']);
app.controller("KKJP1220Ctrl", function($scope, $window, KKJP1220Report, $sce, Message, MsgConst, HttpConst, Dialog,
    ...
    $scope.doExecute = function() {
        ...
        executeDialog.result.then(function() {
            ...
            var report = KKJP1220Report.query($scope.cond, function() {
