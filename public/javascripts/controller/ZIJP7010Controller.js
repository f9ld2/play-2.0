 ...
 * =================================================================== */
var app = angular.module('zijp7010', ['zijp7010Services', 'ui', 'ui.select2', 'directives']);
app.controller("ZIJP7010Ctrl", function($scope, $window, $sce, ZIJP7010Report, Zijp7010Init, Message, MsgConst,
    ...
    $scope.doExecute = function() {
        ...
        confirmDialog.result.then(function() {
            ...
            var report = ZIJP7010Report.query($scope.cond, function() {
    ...
    $scope.initCond = function() {
        var maker = Zijp7010Init.query({}, function() {
            if (maker != undefined) {
