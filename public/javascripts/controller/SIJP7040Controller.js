 ...
 * ===================================================================
 */
var app = angular.module('sijp7040', ['sijp7040Services', 'ui', 'ui.select2', 'directives']);
app.controller("SIJP7040Ctrl", function($scope, $window, $interval, FocusConst, Message, MsgConst, HttpConst, 
		Sijp7040Report, Sijp7040Init, $sce, Dialog, DialogInfo, AppConst, Client, UserInfo, $timeout) {
    ...
    $scope.doExecute = function() {
        ...
        doExecuteDialog.result.then(function() {
            ...
            var report = Sijp7040Report.query($scope.cond, function() {
    ...
    $scope.initCond = function() {
        $timeout(function() {
            var maker = Sijp7040Init.query({}, function() {
                if (maker != undefined) {
