describe('Test cc-shobvnrc-input', function() {
    ...
    beforeEach(inject(function($injector, $sniffer) {
        ...
        $httpBackend.when('GET', '/core/codename/m005bnrm2/5678/01/035/1234?hakkoDay=19010101').respond([record1]);
        $httpBackend.when('GET', '/core/codename/m005bnrm2/5678/01/035/1234?hakkoDay=20140101').respond([record3]);
        $httpBackend.when('GET', '/core/codename/m005bnrm2/1234/01/035/1234?hakkoDay=19010101').respond([record2]);
        $httpBackend.when('GET', '/core/codename/m005bnrm2/1111/01/035/1234?hakkoDay=19010101').respond([]);
        ...
        compile = function(label, partition, id, name, ngModel, required, readOnly, notExist, delexist, shortName,
            ...
            var htmlText = '<cc-shobnrcd-input' + ' cc-label="' + label + '" cc-partition="' + partition + '" id="'
                    ...
                    + '" cc-parameter03="' + para03 + '" cc-parameter04="' + para04 + '" id2="' + id2 + '" name2="' + name2 + '" ng-model2="'
                    + ngModel2 + '" />';
    ...
    describe('display html correctly cases', function() {
        ...
        describe('1st div cases', function() {
            it("should render html of 1st div correctly with required set to true", function() {
                compile("クラス", "3", "shobnrCd", "shobnrCd", "result.shobnrCd", "true", null, "true", "false", "false", "result.jigyobuCd",
                        "result.bmnCd", "result.chubnrCd", "result.hakkoDay", "bnrNm", "bnrNm", "result.bnrNm");
                ...
                expect(element.find('div').eq(0).clone().children().remove().end().text()).toEqual("クラス");
            ...
            it("should render html of 1st div correctly with required set to false", function() {
                compile("クラス", "3", "shobnrCd", "shobnrCd", "result.shobnrCd", 'false', null, "true", "false", "false", "result.jigyobuCd",
                        "result.bmnCd", "result.chubnrCd", "result.hakkoDay", "bnrNm", "bnrNm", "result.bnrNm");
                expect(element.find('div').length).toEqual(1);
            ...
            it("should render html of 1st div correctly with readonly set to true", function() {
                compile("クラス", "3", "shobnrCd", "shobnrCd", "result.shobnrCd", null, "true", "true", "false", "false", "result.jigyobuCd",
                        "result.bmnCd", "result.chubnrCd", "result.hakkoDay", "bnrNm", "result.bnrNm");
                expect(element.find('div').length).toEqual(1);
                expect(element.find('div').eq(0).hasClass("cs-label-large cs-label")).toEqual(true);
                expect(element.find('div').eq(0).clone().children().remove().end().text()).toEqual("クラス");
                expect(element.find('div span').length).not.toEqual(1);
            ...
            it("should render html of 1st div correctly with partition set to empty", function() {
                compile("クラス", "", "shobnrCd", "shobnrCd", "result.shobnrCd", "true", null, "true", "false", "false", "result.jigyobuCd",
                        "result.bmnCd", "result.chubnrCd", "result.hakkoDay", "bnrNm", "bnrNm", "result.bnrNm");
                expect(element.find('div').length).toEqual(1);
        ...
        describe('1st input field', function() {
            ...
            it("should render html correctly when required", function() {
                ...
                expect(element.find('input').eq(0).attr('id')).toEqual("shobnrCd");
                expect(element.find('input').eq(0).attr('name')).toEqual("shobnrCd");
            ...
            it("should render html correctly when readonly", function() {
                compile("クラス", "3", "shobnrCd", "shobnrCd", "result.shobnrCd", null, "true", null, "false", "false", "result.jigyobuCd",
                        "result.bmnCd", "result.chubnrCd", "result.hakkoDay", "bnrNm", "bnrNm", "result.bnrNm");
        ...
        describe('2nd input field', function() {
            ...
            it("should render html correctly", function() {
                ...
                compile("クラス", "3", "shobnrCd", "shobnrCd", "result.shobnrCd", "true", null, "true", "false", "true", "result.jigyobuCd",
                        "result.bmnCd", "result.chubnrCd", "result.hakkoDay", "bnrNm", "bnrNm", "result.bnrNm");
     ...
     describe("logic cases", function() {
        it('it should bind value and view value correctly', function() {
            compile("クラス", "3", "shobnrCd", "shobnrCd", "result.shobnrCd", "true", null, "true", "true", "true", "result.jigyobuCd",
                    "result.bmnCd", "result.chubnrCd", "result.hakkoDay", "bnrNm", "bnrNm", "result.bnrNm");
            ...
            expect(scope.result.shobnrCd).toEqual('5678');
        ...
        it("it should be catch required validation", function() {
            ...
            inputElement.triggerHandler('blur');
            expect(scope.result.shobnrCd).toEqual(undefined);
        ...
        it('it should not populate input no2 with data and display error message when there is no such data in database and notExist set to false', function() {
            compile("クラス", "3", "shobnrCd", "shobnrCd", "result.shobnrCd", "true", null, "false", "false", "false", "result.jigyobuCd",
                    "result.bmnCd", "result.chubnrCd", "result.hakkoDay", "bnrNm", "bnrNm", "result.bnrNm");
            inputElement = element.find('input').eq(0);
            inputElement2 = element.find('input').eq(1);
            var modelCtrl = inputElement.controller('ngModel');
