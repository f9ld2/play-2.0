...
describe('Test directive ccValidateGreaterEqualEqual', function() {
    ...
    beforeEach(inject(function($injector, $sniffer) {
        ...
        compile = function(ngModel, specifyValue) {
            ...
            htmlText += ' cc-validate-greater-equal="' + specifyValue + '"';
            htmlText +=  '/>';
    ...
    describe('ValidatorGreaterEqual', function() {
        // Case 1
        it('Test case 1: Input value is less than specify value', function() {
            ...
            expect(modelCtrl.$error.ccValidateGreaterEqual).toBe(true);
        });
        ...
        it('Test case 2: The input value is greater than the specify value ', function() {
            ...
            expect(modelCtrl.$error.ccValidateGreaterEqual).toBe(false);
        });
